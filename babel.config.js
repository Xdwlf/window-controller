...
module.exports = function (api) {
    ...
    const plugins = [
        ...
        '@babel/plugin-proposal-nullish-coalescing-operator', //Will be implemented soon in Typescript
        '@babel/plugin-proposal-numeric-separator',
        '@babel/plugin-proposal-optional-chaining', //Will be supported in Typescript 3.7
